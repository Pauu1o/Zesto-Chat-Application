                ...
                >
                  <Dialog.Panel className="pointer-events-auto w-screen max-w-md ">
                    <div className="flex h-full flex-col overflow-y-scroll bg-neutral-900 py-6 shadow-xl">
                        ...
                        <div className="flex items-start justify-end">
                          <div className="ml-3 flex h-7 items-center">
                            <button
                              onClick={onClose}
                              type="button"
                              className="rounded-md bg-neutral-900 text-white hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"
                            >
                      ...
                      <div className="relative mt-6 flex-1 text-white px-4 sm:px-4">
                        <div className="flex flex-col items-center">
                          ...
                          <div className="flex gap-10 my-8 ">
                            ...
                            >
                              <div className="w-10 h-10 bg-orange-500 rounded-full flex items-center text-white justify-center">
                                <IoTrash size={20} />
                              </div>
                              ...
                              {!data.isGroup && (
                                <>
                                  ...
                                  <div>
                                    ...
                                    <dd className=" mt-1 text-s text-white sm:col-span-2">
